...
router.get('/list', async (req, res) => {
    var channel_list = await Channel.find({});
...
router.get('/modify/:channel_id', async (req, res) => {
    ...
    var channel_list = await Channel.find({channel_id:channelIdx});
...
router.post('/modify/:channel_id', async (req, res) => {
    ...
    await Channel.updateOne({channel_id:channelIdx}, channel);
    res.redirect('/channel/list');
});

router.get('/delete', async (req, res) => {
    var channelIdx=req.query.channel_id;
    await Channel.deleteOne({channel_id:channelIdx});
    res.redirect('/channel/list');
});
